      ...
      <main>
        ...
        <section className="relative min-h-[90vh] flex items-center pt-16 lg:pt-0 overflow-hidden">
          <div className="absolute inset-0 z-0 hidden lg:block w-1/2 left-0 pointer-events-none">
            <svg
              ...
              className="absolute top-0 left-0 w-[150%] h-full text-primary/20 -translate-x-1/4 scale-150 rotate-12"
            >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-[#A8A8A8] font-light max-w-lg mb-8 leading-relaxed">
                  Gathering the most brilliant minds in The Hague to celebrate
                  bold ideas, diverse perspectives, and stories that spark
                  meaningful change.
                </p>
        ...
        <section className="relative py-32 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img
              src="https://tedxthehague.com/wp-content/uploads/2025/12/DSC01488-scaled.png"
              alt="Audience"
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-white/90 max-w-xl leading-relaxed">
                Have an idea that could change the way people see the world? We
                are looking for visionaries, innovators, and storytellers for
                our upcoming event.
              </p>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="mt-6 text-[#A8A8A8] max-w-2xl mx-auto text-lg">
                We curate a diverse lineup of speakers. Here is what makes a
                great TEDx talk.
              </p>
            </motion.div>
            ...
            >
              {[
                {
                  title: "BOLD IDEAS",
                  desc: "Ideas that challenge the status quo, offer new paradigms, or present groundbreaking research.",
                },
                {
                  title: "POWERFUL STORYTELLING",
                  desc: "Personal narratives that connect deeply, evoke emotion, and drive the core message home.",
                },
                {
                  title: "DIVERSE PERSPECTIVES",
                  desc: "Voices from all walks of life, representing unique experiences, cultures, and disciplines.",
                },
              ].map((card, i) => (
                <motion.div
                  key={i}
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase inline-block">
                <span className="border-b-4 border-black pb-2 mr-4">
                  HOW TO
                </span>
              ...
              {[
                {
                  num: "01",
                  title: "Fill the Form",
                  desc: "Complete the speaker application form with your details.",
                },
                {
                  num: "02",
                  title: "Share Your Idea",
                  desc: "Tell us about your talk topic and why it matters.",
                },
                {
                  num: "03",
                  title: "Upload Video",
                  desc: "Provide a video link of your previous speaking experience.",
                },
                {
                  num: "04",
                  title: "Get Selected",
                  desc: "Our team will review and reach out to selected speakers.",
                },
              ].map((step, i) => (
                <motion.div
                  key={i}
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-10 leading-relaxed font-medium">
                Applications are open until May 1, 2026. Don't miss your chance
                to share your idea on the TEDxTheHague stage.
              </p>
      ...
      <footer className="bg-black py-12 border-t border-white/10">
        <div className="container mx-auto px-6 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <p className="text-sm text-[#A8A8A8] font-medium">
            © 2026 TEDxTheHague. This independent TEDx event is operated under
            license from TED.
          </p>
        </div>
      </footer>
